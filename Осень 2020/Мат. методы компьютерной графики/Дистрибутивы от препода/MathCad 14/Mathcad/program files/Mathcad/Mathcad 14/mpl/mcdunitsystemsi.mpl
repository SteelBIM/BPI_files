...
//*
//*
//*  Version : $Header: /MathcadClient/Trunk/mcd/sources/mpl/mcdunitsystemsi.mpl   62   2007-01-04 15:41:03-05:00   jkucan $
//*
//*
...
//   import McdUnits as McdUnitSystemSI(Mass,Length,Time,Current,Temperature,Luminosity,Substance,Money); // JK: disabled for 14.0 GOLD
   import McdUnits as McdUnitSystemSI(Mass,Length,Time,Current,Temperature,Luminosity,Substance);
   import McdUnits;
   import McdRun;
...
//   op_D           :: Value{} -> Value{Money       60000} @ 46; // JK: disabled for 14.0 GOLD

// Mathcad Units

//   mc_¤           = rv(basecurrency);		// JK: disabled for 14.0 GOLD
   mc_μ_2E_0      = rv(mu0);
...
//      unit("¤",         "¤",     "Money",                mc_¤,       typeof mc_¤),	// JK: disabled for 14.0 GOLD
