          ...
          (lambda (env)
            (let* ((constraints (constraints-f env))
              ...
              `(op_solve 
                ...
                ,(possibly-vector (get-senses constraints) sym?)
...
(defun get-senses (constraints)
  (mapcar sense constraints))

(defun mcstr (s)
  `(front12.string ,s))

(defun sense (constraint)
  (let ((op (no-tag (car constraint))))
    (cond ((eqt op 'front12.op_eq)  (mcstr "E"))
          ((eqt op 'front12.op_lt)  (mcstr "L"))
          ((eqt op 'front12.op_leq) (mcstr "L"))
          ((eqt op 'front12.op_geq) (mcstr "G"))
          ((eqt op 'front12.op_gt)  (mcstr "G")))))
